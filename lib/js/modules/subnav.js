...
module.exports = {
	...
	states: {
		...
		activeSubnav: "active-subnav" // When a child subnav is opened (applied to parent)
	},
	...
	close: function () {
		...
		this.parentElement.classList.remove(module.exports.states.activeSubnav);
